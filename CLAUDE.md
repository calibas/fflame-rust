...
- **Color Modes**: Palette (Apophysis color-coordinate evolution), Speed (distance per iteration), PathMap (colours each part of the picture by its path -- the transforms Focused Rendering draws it through; needs Focused Rendering, 2D; see `docs/projects/word-editing.md` §10)
