...
export interface InitOutput {
  ...
  readonly closure1773_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1860_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure1873_externref_shim: (a: number, b: number, c: any, d: any) => void;
