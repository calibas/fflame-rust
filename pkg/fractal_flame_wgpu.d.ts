...
export interface InitOutput {
  ...
  readonly closure1743_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1830_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure1843_externref_shim: (a: number, b: number, c: any, d: any) => void;
