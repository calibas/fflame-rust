...
| 5 | Simulation panel split | — — **planned separately**: the ask grew past a split into merging Model with Layers and Colouring with the colour stack, so it has its own plan of record, [simulation-panel.md](simulation-panel.md) |
