...
These links go much deeper into the math behind fractal flames. They're more for advanced users, and aren't required to use the program:

1. [The Fractal Flame Algorithm (PDF)](https://flam3.com/flame_draves.pdf)
2. [Fractal flame - Wikipedia](https://en.wikipedia.org/wiki/Fractal_flame)
