        ...
        if let Some(viewport_size) = ui_response.fractal_viewport_size {
            ...
            if should_resize {
                ...
                if let Some(ref mut renderer) = self.flame_renderer {
                    ...
                    renderer.update_palette(&self.gpu.device, &self.gpu.queue, &resize_config.palette, resize_config.palette_rotation, resize_config.palette_squeeze, resize_config.palette_squeeze_mode, resize_config.palette_squeeze_falloff, resize_config.palette_reverse);
