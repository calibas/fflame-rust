...
pub static SUPERSHAPE_3D: VariationDef = VariationDef {
    ...
    parameters: &[
        ...
        param!("toroidmap", "Toroidal", bool, false, "0 = spherical projection (output = `r1·r2·cos·cos`, etc.). 1 = toroidal projection (output = `cos·(r1 + r2·cos)`, etc.). Both modes use `r2·sin(φ)` for Z."),
    ],
