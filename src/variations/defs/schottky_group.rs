...
pub static SCHOTTKY_GROUP: VariationDef = VariationDef {
    ...
    parameters: &[
        ...
        param!("space", "Space", enum, 0, &["Planar", "Hyperbolic H3"], "3D render mode only. Planar: the Möbius orbit in the xy plane (z passes through). Hyperbolic H3: the Poincaré extension — the pairing circles become hemispheres acting on upper half-space. The t→0 slice is the 2D picture."),
