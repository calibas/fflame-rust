...
pub static SEASHELL3D: VariationDef = VariationDef {
    ...
    parameters: &[
        param!("final_radius", "Final Radius", unlimited_float, 0.25, -10.0, 10.0, "Final-spiral radius (outer-edge radius coefficient)."),
        param!("height", "Height", unlimited_float, 3.5, -20.0, 20.0, "Height ramp coefficient on Z."),
        param!("inner_radius", "Inner Radius", unlimited_float, 0.4, -10.0, 10.0, "Inner-spiral radial offset added to X and Y."),
        param!("nSpirals", "N Spirals", int, 3.0, 1.0, 50.0, "Number of spiral turns."),
    ],
    init_param_count: 0,
    wgsl_init: None,
    state_count: 0,
