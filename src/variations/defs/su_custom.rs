...
pub static SU_CUSTOM: VariationDef = VariationDef {
    ...
    parameters: &[
        ...
        param!("red_a_re", "Reduce A re", unlimited_float, 1.0, -4.0, 4.0, "Real part of the reduction-tensor entry a (SU(3): tt = [[1,0,1],[a,b,c]]). The reduction is a free design choice — each (a,b,c) gives a different fractal in the SU(3) family. Computed live via the init pass."),
