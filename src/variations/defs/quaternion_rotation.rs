...
const WGSL_2D: &str = r#"
fn variation_quaternion_rotation(p: vec2<f32>, xform_id: u32, variation_id: u32) -> vec2<f32> {
...
fn variation_quaternion_rotation(p: vec3<f32>, xform_id: u32, variation_id: u32) -> vec3<f32> {
    let a_raw = vec4<f32>(
