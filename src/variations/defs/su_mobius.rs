...
//!
//! Bagula's ⟨2,3,12⟩ Kleinian *triangle* group is a separate
//! construction (not a special-unitary reduction) and lives in its own
//! [`fuchsian_triangle`](super::fuchsian_triangle) variation — it shares
//! the SL(2,ℂ) machinery in `shaders/core/su_mobius.wgsl`.
//!
...
pub static SU_MOBIUS: VariationDef = VariationDef {
    ...
    parameters: &[
        param!("group", "Group", enum, 1, &["SU(2) 6-Group", "SU(3) Reduced", "SU(5) Reduced", "SU(3) Custom", "SU(4) Reduced", "SU(2) Custom", "SU(4) Custom", "SO(5) Reduced"], "Which Lie-group generator set. SU(2) 6-Group (12 generators) — set Angle 0 / Hyper Angle 45 for Bagula's hypertriquasiconformal Apollonian disk. SU(3) Reduced (16 generators) — Angle 45 / Hyper 0 (the defaults) for the three-quark-disk limit set. SU(5) Reduced (48 gens, our reduction) — pair with Symmetry 4-Fold. Custom groups (SU(2)/SU(3)/SU(4)) compute their reduction LIVE from the Reduce A/B/C/D + Plug sliders (init pass) — dial the reduction tensor and the pole-plug to explore the infinite SU(n) family and the circle packing. SU(4) Reduced is a baked our-reduction (30 gens). SO(5) Reduced (20 gens): the antisymmetric subset of the generalized Gell-Mann set is exactly so(5) ≅ sp(4) — same reduction tensor and trace plug, the rotation-only cousin of SU(5) (Bagula's companion series). For Bagula's ⟨2,3,12⟩ triangle group see the separate Fuchsian Triangle variation."),
