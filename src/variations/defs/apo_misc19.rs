...
pub static MOBIUS_STRIP: VariationDef = VariationDef {
    ...
    parameters: &[
        ...
        param!("width_mode", "Width Mode", enum, 0, &["Wrap", "Clamp", "Hide", "Leave"], "Y out-of-range behavior: 0 = wrap, 1 = clamp, 2 = hide, 3 = leave (pass through)."),
        param!("radial_mode", "Radial Mode", enum, 0, &["Wrap", "Clamp", "Hide", "Leave"], "X out-of-range behavior: same 4-mode enum as `width_mode`."),
    ],
