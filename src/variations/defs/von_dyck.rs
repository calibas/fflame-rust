...
pub static VON_DYCK: VariationDef = VariationDef {
    ...
    parameters: &[
        ...
        param!("seed", "Seed", enum, 2, &["Input", "Vertices", "Edges", "Faces"], "What the walk stamps through the tiling: the incoming flame measure, the triangle's vertex orbit, its edge skeleton (geodesic segments), or face fragments — honeycomb's seed machinery on Möbius orbits."),
