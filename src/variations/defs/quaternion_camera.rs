...
pub static QUATERNION_CAMERA: VariationDef = VariationDef {
    ...
    parameters: &[
        param!("cam_x", "Camera X", float, 0.0, -4.0, 4.0, "4D eye position, x/i component (subtracted from the point before rotation/projection)."),
        param!("cam_y", "Camera Y", float, 0.0, -4.0, 4.0, "4D eye position, y/j component."),
        param!("cam_z", "Camera Z", float, 0.0, -4.0, 4.0, "4D eye position, z/k component."),
        param!("cam_w", "Camera W", float, 0.0, -4.0, 4.0, "4D eye position along the 4th axis — THE slider this variation exists for. Sweep it to fly through the object in w; with Perspective > 0, parts you pass are clipped away like a real fly-through."),
        param!("rot_xw", "Rotate XW", float, 0.0, -3.1416, 3.1416, "Rotation of the (x, w) plane in radians — turns the view into the 4th dimension (a '4D yaw'). The ordinary xy/xz/yz rotations belong to the engine's 3D camera."),
        param!("rot_yw", "Rotate YW", float, 0.0, -3.1416, 3.1416, "Rotation of the (y, w) plane in radians (a '4D pitch')."),
        param!("rot_zw", "Rotate ZW", float, 0.0, -3.1416, 3.1416, "Rotation of the (z, w) plane in radians."),
