...
pub static FUCHSIAN_TRIANGLE: VariationDef = VariationDef {
    ...
    parameters: &[
        ...
        param!("tri_trace", "Tri Trace", unlimited_float, 0.0, -4.0, 4.0, "Trace of the first generator s1 = [[t,-1],[1,0]]. |t| > 2 is hyperbolic (Bagula's 3 — spreads the elliptic circles fractally), t = 2 parabolic, t = 2·cos(π/n) elliptic of order n."),
        param!("tri_q", "Tri Order Q", int, 7.0, 1.0, 24.0, "Order of the second generator s2 = [[e^{2πi/q}, shear],[0, e^{-2πi/q}]] — an elliptic rotation of order q (Bagula's 3). Its orbits paint the mid-scale circles."),
        param!("tri_r", "Tri Order R", int, 8.0, 1.0, 24.0, "Order of the third generator s3 — the elliptic rotation by 2π/r fixing ±1 (Bagula's 12, the ⟨2,3,12⟩ 30° angle). Its orbits paint the fine circle rings."),
        param!("tri_shear", "Tri Shear", unlimited_float, -4.0, -4.0, 4.0, "The off-diagonal shear in s2 (Bagula's 3). Pushes s2's two fixed points apart — 0 makes s2 a pure diagonal rotation about 0/∞."),
