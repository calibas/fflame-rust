...
pub static CHUNK: VariationDef = VariationDef {
    ...
    parameters: &[
        ...
        param!("mode", "Mode", bool, false, "Which side of `r = 0` to keep: 0 = keep where r ≤ 0, 1 = keep where r > 0."),
    ],
...
pub static PTRANSFORM: VariationDef = VariationDef {
    ...
    parameters: &[
        ...
        param!("use_log", "Use Log", bool, true, "Whether to apply log/exp around ρ: 0 = linear radius, 1 = true log-polar."),
    ],
    needs_transform: false,
    writes_color: false,
    init_param_count: 0,
...
pub static TILE_REVERSE: VariationDef = VariationDef {
    ...
    parameters: &[
        ...
        param!("vertical", "Vertical", bool, false, "Tiling axis selector: 0 = horizontal, 1 = vertical."),
    ],
    needs_transform: false,
    writes_color: false,
    init_param_count: 0,
